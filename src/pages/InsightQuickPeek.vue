<template>
  <div class="content-holder">
    ...
    <div class="sections">
      ...
      />
      <InsightSubHeader
        content="As such, we help our collaborators to formulate their own unique Data Strategy, so that all data related processes, policies and decisions are focussed on the main goals and direction of the business. These activities are spread across two solutions: Data Architecture and Data Modelling & Design, each of which can be applied dependent on the unique needs of any potential collaborators. "
      ></InsightSubHeader>
