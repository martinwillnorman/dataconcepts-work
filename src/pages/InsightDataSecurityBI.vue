<template>
  <div class="content-holder">
    ...
    <div class="sections">
      ...
      />
      <InsightSubHeader
        content="These examples are just some of the most recent and noteworthy data breaches in the news. But data security issues can occur on a far smaller scale and these security issues can ultimately lead to big data losses for organizations if not properly addressed."
      ></InsightSubHeader>
      <section class="content-block slant-4 padded-top">
        <div class="container">
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Robust and secure IoT API solutions."></InsightSubSection>
          <InsightSubSection
            content="- BI and data analytical solutions with your data security needs in mind."
          ></InsightSubSection>
          <InsightSubSection content="- IoT data analytical strategies for securing data."></InsightSubSection>s
          <InsightSubSection
