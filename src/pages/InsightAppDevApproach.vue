    ...
    <div class="sections">
      ...
      <section class="content-block">
        <div class="container">
          ...
          <InsightSubSection
            class="subsection-padding"
            title="Client-centric governance model:"
...
.insight-image
  ...
  background-image: url(../assets/background/insights/hands.jpg)
</style>
