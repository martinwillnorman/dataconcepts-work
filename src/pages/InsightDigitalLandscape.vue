    ...
    <div class="sections">
      ...
      <section class="content-block slant-4 padded-top">
        <div class="container">
          ...
          <InsightSubSection
            class="padded-bottom"
            content="A modern digital application platform typically includes some combination of the following technologies and methodologies:"
          ></InsightSubSection>
          <InsightSubSection content="- Microservices and APIs"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Agile development"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Internet of Things"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Virtualization and containers"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Artificial intelligence (AI)"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
          ...
          ></InsightSubSection>
          <InsightSubSection content="- Data services"></InsightSubSection>
          <InsightSubSection
            class="padded-bottom"
