<template>
  <section class="content-block light-black subfooter">
    <div class="container">
      <div class="row">
        <div class="column col-12">
          <div class="content-wrapper subfooter-wrapper">
            ...
            <div class="logo-wrapper">
              <router-link class="subfooter-logo" to="/">dataconcepts</router-link>
            </div>
...
.subfooter
    background: $bround-c-sub-footer
    position: relative
    padding: 30px 0
